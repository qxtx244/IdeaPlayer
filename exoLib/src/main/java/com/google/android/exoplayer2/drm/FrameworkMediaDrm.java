...
public final class FrameworkMediaDrm implements ExoMediaDrm<FrameworkMediaCrypto> {
  ...
  @Override
  public void setOnExpirationUpdateListener(final OnExpirationUpdateListener<? super FrameworkMediaCrypto> listener, Handler handler) {
    mediaDrm.setOnExpirationUpdateListener(listener == null ? null : new MediaDrm.OnExpirationUpdateListener() {
      @Override
      public void onExpirationUpdate(@NonNull MediaDrm md, @NonNull byte[] sessionId, long expirationTime) {
        listener.onExpirationUpdate(md, sessionId, expirationTime);
      }
    }, handler);
  }

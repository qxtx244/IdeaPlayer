...
public class SimpleExoPlayer implements ExoPlayer, Player.VideoComponent, Player.TextComponent {
  ...
  private CopyOnWriteArraySet<Player.EventListener> listeners;
  public CopyOnWriteArraySet<Player.EventListener> getListeners() {
    return listeners;
  }
  ...
  protected SimpleExoPlayer(
    ...
    player = createExoPlayerImpl(renderers, trackSelector, loadControl, clock, listeners);
  ...
  public void setAspectRatio(int width, int height, int degrees, float pixelRatio) {
    componentListener.onVideoSizeChanged(width, height, degrees, pixelRatio);
  }
  ...
  protected ExoPlayer createExoPlayerImpl(
          Renderer[] renderers, TrackSelector trackSelector, LoadControl loadControl, Clock clock, CopyOnWriteArraySet<Player.EventListener> listeners) {
    return new ExoPlayerImpl(renderers, trackSelector, loadControl, clock, listeners);
  }
  ...
  protected ExoPlayer createExoPlayerImpl(Renderer[] renderers, TrackSelector trackSelector, LoadControl loadControl, Clock clock) {
    return createExoPlayerImpl(renderers, trackSelector, loadControl, clock, new CopyOnWriteArraySet<Player.EventListener>());
  }

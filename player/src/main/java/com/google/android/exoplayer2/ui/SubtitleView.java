...
public final class SubtitleView extends View implements TextOutput {
  ...
  private final List<com.google.android.exoplayer2.ui.SubtitlePainter> painters;
  ...
  public void setCues(@Nullable List<Cue> cues) {
    ...
    while (painters.size() < cueCount) {
      painters.add(new com.google.android.exoplayer2.ui.SubtitlePainter(getContext()));
    }
  ...
  public void dispatchDraw(Canvas canvas) {
    ...
    for (int i = 0; i < cueCount; i++) {
      ...
      com.google.android.exoplayer2.ui.SubtitlePainter painter = painters.get(i);
      painter.draw(
          cue,
          applyEmbeddedStyles,

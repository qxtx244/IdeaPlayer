...
import org.qxtx.idea.player.R;

import java.util.List;

/**
 * A high level view for {@link Player} media playbacks. It displays video, subtitles and album art
 * during playback, and displays playback controls using a {@link com.google.android.exoplayer2.ui.PlayerControlView}.
 *
 ...
 *       inflated by the child {@link com.google.android.exoplayer2.ui.PlayerControlView}. See below for more details.
 *       <ul>
 *         <li>Corresponding method: None
 *         <li>Default: {@code R.id.exo_player_control_view}
 *       </ul>
 *   <li>All attributes that can be set on a {@link com.google.android.exoplayer2.ui.PlayerControlView} can also be set on a
 *       PlayerView, and will be propagated to the inflated {@link com.google.android.exoplayer2.ui.PlayerControlView} unless the
 ...
 *       {@link com.google.android.exoplayer2.ui.PlayerControlView}. Ignored if an {@code exo_controller} view exists.
 *       <ul>
 *         <li>Type: {@link View}
 *       </ul>
 *   <li><b>{@code exo_controller}</b> - An already inflated {@link com.google.android.exoplayer2.ui.PlayerControlView}. Allows use
 *       of a custom extension of {@link com.google.android.exoplayer2.ui.PlayerControlView}. Note that attributes such as {@code
 ...
 *       <ul>
 *         <li>Type: {@link com.google.android.exoplayer2.ui.PlayerControlView}
 *       </ul>
...
public class PlayerView extends FrameLayout {
  ...
  public PlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    com.google.android.exoplayer2.ui.PlayerControlView customController = findViewById(R.id.exo_controller);
    ...
    if (customController != null) {
      ...
      this.controller = new com.google.android.exoplayer2.ui.PlayerControlView(context, null, 0, attrs);
  ...
  public com.google.android.exoplayer2.ui.PlayerControlView getController() {
    return controller;
  }
   ...
   */
  public void setControllerVisibilityListener(com.google.android.exoplayer2.ui.PlayerControlView.VisibilityListener listener) {
    Assertions.checkState(controller != null);

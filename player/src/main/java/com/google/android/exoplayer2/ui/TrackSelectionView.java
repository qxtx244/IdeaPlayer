...
public class TrackSelectionView extends LinearLayout {
  ...
  public TrackSelectionView(
    ...
    trackNameProvider = new com.google.android.exoplayer2.ui.DefaultTrackNameProvider(getResources());
  ...
  /**
   * Sets the {@link com.google.android.exoplayer2.ui.TrackNameProvider} used to generate the user visible name of each track and
   * updates the view with track names queried from the specified provider.
   *
   * @param trackNameProvider The {@link com.google.android.exoplayer2.ui.TrackNameProvider} to use.
   */

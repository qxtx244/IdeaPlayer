...
#    public static int w(...);
#    public static int d(...);
#-assumenosideeffects class org.qxtx.idea.player.utils.IdeaLog {
...
-keep class org.qxtx.idea.player.base.** {*;}
-keep class org.qxtx.idea.player.utils.** {*;}
-keep class org.qxtx.idea.player.exception.** {*;}
-keep class org.qxtx.idea.player.** {
    public *;
}
...
-keep class com.google.android.exoplayer2.source.chunk.** {*;}
-keep class com.google.android.exoplayer2.** {public *;}

#----------------注意不能混淆带Class.forName()方法的类或方法名，也不能混淆加载so的类
-keep class org.qxtx.idea.player.** {
    public void showTrackManager*;
}
-keep class com.google.android.exoplayer2.util.Util {*;}
-keep class com.google.android.exoplayer2.drm.DefaultDrmSession {*;}
...
-keep class com.google.android.exoplayer2.extractor.DefaultExtractorsFaceory {*;}